...
```{=html}
<style>
  /* Override the library's internal scoped width */
  .scope-5pi-i5dkkfhg {
  ...
  /* Override the media query width on the outer container */
  #O-scope-1 {
    width: 900px !important;
    margin-left: 40px !important;
    margin-right: 20px !important;
  ...
  /* Override the fixed 360px media query */
...
```{ojs}
{
  ...
  const marks = [
  Plot.lineY(This_Year, { x: "Normalized_Date", y: "Elevation", stroke: "blue" }),
  ...
  Plot.tip(This_Year, Plot.pointerX({ x: "Normalized_Date", y: "Elevation" }))
  ]
...
```{ojs}
{
  ...
  const marks = [
  Plot.lineY(This_Year, { x: "Normalized_Date", y: "Storage_MAF", stroke: "blue" }),
  ...
  Plot.tip(This_Year, Plot.pointerX({ x: "Normalized_Date", y: "Storage_MAF" }))
  ]
